...
module.exports = (sequelize,DataTypes)=>{
    ...
    Diagnostico_especialidad_tratamiento.associate = models =>{
        ...
        Diagnostico_especialidad_tratamiento.belongsTo(models.diagnostico_especialidad) 
        Diagnostico_especialidad_tratamiento.belongsTo(models.tratamiento) 
        Diagnostico_especialidad_tratamiento.hasMany(models.atencion)
    }

    return Diagnostico_especialidad_tratamiento
}